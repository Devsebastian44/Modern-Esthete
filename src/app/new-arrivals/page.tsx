        ...
        <div className="min-h-screen bg-[#fafafa]">
                    ...
                    <div className="relative min-h-[560px] flex flex-col items-center justify-center p-8 text-center overflow-hidden rounded-2xl">
                        ...
                        <div className="relative z-20 flex flex-col gap-6 max-w-3xl">
                            ...
                            <div className="flex flex-wrap gap-4 justify-center mt-6">
                                <button className="bg-white text-[#0f172a] px-10 py-4 text-xs font-black uppercase tracking-widest hover:bg-zinc-100 transition-colors shadow-2xl">
                                    Shop the drop
                                </button>
            ...
            <section className="sticky top-[73px] z-40 w-full bg-[#fafafa]/90 backdrop-blur-md border-y border-slate-200 py-4">
                <div className="max-w-[1400px] mx-auto px-6 lg:px-12 flex flex-wrap items-center justify-between gap-6">
                    <div className="flex gap-4 overflow-x-auto no-scrollbar items-center">
                        <button className="text-xs font-black uppercase tracking-widest text-[#0f172a] border-b-2 border-[#0f172a] pb-1 shadow-[0_1px_0_0_#0f172a]">All Items</button>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button className="flex items-center gap-2 border-b border-slate-300 pb-1 text-xs font-bold text-[#0f172a]">
                            Release Date
            ...
            <section className="max-w-[1400px] mx-auto px-6 lg:px-12 py-16 w-full">
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
                    <div>
                        <h2 className="text-[#0f172a] text-4xl font-black uppercase tracking-tighter">The New Standard</h2>
                        <div className="flex items-center gap-3 mt-2">
                            ...
                            <span className="text-xs font-bold text-[#0f172a] uppercase tracking-widest">Season 02</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-16">
                    ...
                    <div className="group flex flex-col">
                        <div className="relative w-full aspect-[4/5] overflow-hidden bg-zinc-100 mb-6 rounded-lg">
                            <div className="absolute top-4 left-4 z-10 bg-[#0f172a] text-white px-2 py-1 text-[9px] font-black uppercase tracking-widest rounded-sm">NEW</div>
                            <button className="absolute top-4 right-4 z-10 size-9 flex items-center justify-center rounded-full bg-white/90 opacity-0 group-hover:opacity-100 transition-opacity">
                            ...
                            ></div>
                            <div className="absolute inset-x-0 bottom-0 p-4 translate-y-full group-hover:translate-y-0 transition-transform bg-white/80 backdrop-blur-md">
                                <button
                                    onClick={(e) => {
                                        e.preventDefault();
                                        addToCart({
                                    ...
                                    className="w-full py-3 bg-[#0f172a] text-white font-black text-[10px] uppercase tracking-widest hover:bg-slate-800 transition-colors rounded-sm"
                                >
                                    Quick Add
                                </button>
                            </div>
                        ...
                        <div className="flex justify-between items-start">
                            <div className="space-y-1">
                                <h3 className="text-[#0f172a] text-sm font-bold uppercase tracking-tight">Tech-Knit Blazer</h3>
                                <p className="text-slate-400 text-[10px] font-bold uppercase tracking-widest">Carbon / Technical Blend</p>
                            </div>
                            <p className="text-[#0f172a] text-sm font-black">$245</p>
                        </div>
                    </div>
                    ...
                    <div className="group flex flex-col">
                        ...
                        <div className="flex justify-between items-start">
                            <div className="space-y-1">
                                <h3 className="text-[#0f172a] text-sm font-bold uppercase tracking-tight">Minimalist Chrono</h3>
                                <p className="text-slate-400 text-[10px] font-bold uppercase tracking-widest">Titanium / Sapphire</p>
                            </div>
                            <p className="text-[#0f172a] text-sm font-black">$180</p>
                        </div>
                    </div>
                    ...
                    <div className="group flex flex-col">
                        ...
                        <div className="flex justify-between items-start">
                            <div className="space-y-1">
                                <h3 className="text-[#0f172a] text-sm font-bold uppercase tracking-tight">Urban Parka</h3>
                                <p className="text-slate-400 text-[10px] font-bold uppercase tracking-widest">Sand / Weatherproof</p>
                            </div>
                            <p className="text-[#0f172a] text-sm font-black">$320</p>
                        </div>
                    </div>
                    ...
                    <div className="group flex flex-col">
                        <div className="relative w-full aspect-[4/5] overflow-hidden bg-zinc-100 mb-6 rounded-lg">
                            <div className="absolute top-4 left-4 z-10 bg-[#0f172a] text-white px-2 py-1 text-[9px] font-black uppercase tracking-widest rounded-sm">LIMITED</div>
                            <div
                                className="w-full h-full bg-center bg-cover transition-transform duration-700 group-hover:scale-105"
                        ...
                        <div className="flex justify-between items-start">
                            <div className="space-y-1">
                                <h3 className="text-[#0f172a] text-sm font-bold uppercase tracking-tight">Silk Essential</h3>
                                <p className="text-slate-400 text-[10px] font-bold uppercase tracking-widest">Midnight / 100% Silk</p>
                            </div>
                            <p className="text-[#0f172a] text-sm font-black">$110</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-[1400px] mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    <div className="space-y-10">
                        <div className="space-y-4">
                            ...
                            <h2 className="text-[#0f172a] text-5xl md:text-7xl font-black leading-none tracking-tighter uppercase">The Vertex<br />Collection</h2>
                        ...
                        <div className="flex flex-col sm:flex-row gap-0 border border-slate-200 max-w-lg rounded-lg overflow-hidden">
                            <input
                                ...
                                type="email"
                            />
                            <button className="h-14 px-10 bg-[#0f172a] text-white text-xs font-black uppercase tracking-widest hover:bg-slate-800 transition-all">
                                Join Waitlist
                            </button>
                        </div>
                    </div>
                    <div className="relative">
                        ...
                        <div className="relative w-full aspect-video bg-zinc-100 overflow-hidden rounded-2xl">
                            ...
                            ></div>
                            <div className="absolute inset-0 flex items-center justify-center bg-[#0f172a]/10">
